...
Here you will find links pointing toward: [Literature]((docs/literature.md)), [Datasets](docs/datasets.md), [Code bases/Repositories](docs/code_bases.md) and [Media](docs/media.md).

<iframe src="data/html_files/interactive_plot.html" width="100%" height="520" style="border:0;"></iframe>
